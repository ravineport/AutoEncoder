...
class AutoEncoderMinibatch(ae.AutoEncoder):
    ...
    def param_update(self):
        ...
        パラメータの更新
        '''
        self.W2 -= self.eta * self.gW2_sum / self.batch_size
        self.b2 -= self.eta * self.gb2_sum / self.batch_size
        self.W1 -= self.eta * self.gW1_sum / self.batch_size
        self.b1 -= self.eta * self.gb1_sum / self.batch_size
...
if __name__ == '__main__':
    ae = AutoEncoderMinibatch('./data/dataset.dat')
